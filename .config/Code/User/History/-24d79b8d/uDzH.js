...
export default function Home() {
    return (
        <>
            <Head>
                <title>
                    More than 1000 Peel and Stick Vinyl Designes for your home!
                </title>
                <meta
                    name="description"
            ...
            <main className="container mx-auto text-neutral-900 flex flex-col gap-8">
                ...
                <section className="my-8 flex flex-col gap-14" id="faq">
                    ...
                    <div>
                        ...
                        <p className="mt-4 leading-7">
                            Peel and stick tiles are easy to care for and
                            require little maintenance. You can clean them with
                            the products that are already in your house, and
                            prevent water damage by wiping your peel and stick
                            tiles regularly.
                        </p>
                        <p>
                            Or, if they are installed in a high-moisture
                            location, you might apply a sealant on top to close
                            the gaps between the tiles. If you want to increase
                            the adhesive power of your tiles, you might
                            consider:
                        </p>
                        <ul>
                            <li>Cleaning the floor underneath</li>
                            <li>Applying a flawless underlayment</li>
                            <li>Applying another whole layer of adhesive</li>
                        </ul>
                        <p>
                            In some areas of the house, self-adhesive vinyl
                            tiles might be more prone to “unsticking.” In this
                            case, you should consider adding another layer of
                            adhesive and maintain them often to prevent damage.
                        </p>
                    </div>
                </section>
