            ...
            <div className="">
                {comments && comments.length > 0 &&
                    ...
                    <div className='flex flex-col gap-4 mt-8 group' key={i}>
                        ...
                        <p>{comment.comment}</p>
                        <button className="self-start text-sm flex items-center gap-2" onClick={() => user ? likeComment(comment) : renderLogin(true)}>
                        ...
                        >
                            ...
                            <div className="fixed inset-0 flex items-center justify-center p-4">
                                <Dialog.Panel className="mx-auto rounded-2xl bg-white p-16">
                                    <Dialoga />
                                </Dialog.Panel>
                            </div>
                        </Dialog>
