export default function Footer() {
    return (
        <footer className="grid grid-rows-2 px-4 md:grid-rows-none md:grid-cols-2 gap-14 md:gap-0 justify-center text-primary bg-darkest text-white py-14 md:px-10 xl:px-32">
            <div className="flex flex-col gap-6">
                <h1 className="font-bold text-4xl uppercase">Logo</h1>
                <p className="text-sm text-gray-400 max-w-lg leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, eum. Minus voluptate vitae distinctio aspernatur libero, pariatur amet</p>
