export default function Footer() {
    return (
        <footer className="grid grid-rows-2 md:grid-rows-none md:grid-cols-2 gap-14 md:gap-0 justify-center text-primary bg-darkest text-white py-14 md:px-40">
            <div className="flex flex-col gap-6">
                <h1 className="font-bold text-4xl uppercase">Logo</h1>
                <p className="text-sm text-gray-400 max-w-md">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, eum. Minus voluptate vitae distinctio aspernatur libero, pariatur amet</p>
            ...
            <div className="flex gap-14 -order-1 md:order-2">
                <div className="flex flex-col gap-4">
                    <h3 className="text-xl font-medium">Contacto</h3>
                        ...
                        <ul className="flex gap-6 items-center" role="List" aria-label="Social Icons">
                            <li>
                                <a href="" aria-label="Facebook">
                                    <img className="h-7" src="assets/facebook.svg" alt="" />
                                </a>
                            </li>
                            <li>
                                <a href="" aria-label="Instagram">
                                    <img className="h-7" src="assets/instagram.svg" alt="" />
                                </a>
                            </li>
                            <li>
                                <a href="" aria-label="Linked In">
                                    <img className="h-7" src="assets/linkedin.svg" alt="" />
                                </a>
                            </li>
                        </ul>
                    </div>
