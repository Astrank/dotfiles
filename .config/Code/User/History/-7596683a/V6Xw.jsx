export default function Footer() {
    return (
        <footer className="grid grid-rows-2 px-4 gap-14 sm:px-10 md:px-14 lg:px-18 xl:px-32 md:grid-rows-none md:grid-cols-2 md:gap-0 justify-center text-primary bg-darkest text-white py-14">
