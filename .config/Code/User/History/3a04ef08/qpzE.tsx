...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            <button className="relative text-white flex gap-14 items-center justify-center px-4 py-2 bg-google border border-2 rounded text-sm border-google-hover hover:bg-google-hover" onClick={() => google()}>
