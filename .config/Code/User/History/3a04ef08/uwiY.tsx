...
const Login = () => {
    ...
    return (
        <div
            className="flex flex-col justify-center text-primary-900 mx-auto bg-white p-14"
        >
            <svg  className="w-6 h-6 self-end mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
