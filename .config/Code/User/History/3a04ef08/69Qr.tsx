...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            <button className="text-white flex gap-14 items-center justify-start px-4 py-2 bg-google border border-2 rounded text-sm border-google-hover hover:bg-google-hover" onClick={() => google()}>
