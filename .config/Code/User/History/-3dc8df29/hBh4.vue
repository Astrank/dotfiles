<template>
    <div class="spotify">
        <div class="spotify-search">
            ...
            <button class="spotify-search-btn" @click="asd()">
        ...
        <div class="tracks">
            <div v-for="t in this.tracks" class="track" :key="t.id" @click="getTrack(t.id)">
        ...
        async searchTrack() {
            if(this.input.length > 0) {
                ...
                await fetch(`https://api.spotify.com/v1/search?q=${this.input}&type=track&limit=50`, {
                    ...
                    .then(res => res.json())
                    .then(data => this.tracks = data.tracks.tracks.items);
            }
        },
        asd() {
            this.tracks = []
