...
export default function Footer() {
    return (
        <footer className="flex justify-between items-center mx-4 my-3 font-darker_grotesque text-1xl 
                            tracking-wide text-primary-900 md:mx-10 md:my-8 lg:mx-14 lg:my-8 xl:mx-24 xl:my-6">
