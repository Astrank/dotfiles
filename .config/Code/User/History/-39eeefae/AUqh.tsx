...
export default function Footer() {
    return (
        <footer className="flex justify-between items-center mx-4 my-3 md:mx-10 md:my-8 lg:mx-24 lg:my-6 font-darker_grotesque text-1xl tracking-wide text-primary-900">
