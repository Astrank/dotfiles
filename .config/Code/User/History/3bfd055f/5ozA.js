    ...
    return (
        <div className="font-poppins">
            ...
            <main className={`${!isContentReady ? 'hidden' : 'flex flex-col text-primary'}`}>
                {/* LANDING */}
                <section className="relative flex flex-col gap-4 mb-10 py-28 md:py-36">
                ...
                {/* AREAS */}
                <section
                    className="flex flex-col items-center pt-10 gap-14 mb-10 px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32"
                ...
                {/* PROFESIONALES */}
                <section
                    className="flex flex-col items-center gap-14 pt-10 pb-16 px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32 "
                    id="profesionales"
                >
                    <div>
                        <h2 className="text-2xl md:text-3xl font-bold font-lora">
