                ...
                <section className="relative flex flex-col gap-4 py-28 md:py-36 mb-10">
                    <div className="z-10 flex flex-col gap-6 px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32">
                        ...
                        <div className="flex gap-6 mt-4 font-semibold">
                            <button className="bg-white text-primary text-sm px-5 py-4 md:px-6 rounded self-start">
                                PUBLICACIONES
                            </button>
                            <button className="bg-accent text-white border-b border-accent text-sm px-5 py-4 md:px-6 rounded self-start hover:bg-accent_light">
                                CONSULTAS
                            </button>
                        </div>
                    </div>
