    ...
    return (
        <div className="font-poppins">
            ...
            <main className={`${!isContentReady ? 'hidden' : 'flex flex-col text-primary'}`}>
                ...
                {/* PROFESIONALES */}
                <section
                    className="flex flex-col items-center gap-14 py-14 px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32 "
                    id="profesionales"
                >
                    <div>
                        <h2 className="text-2xl md:text-3xl font-bold font-lora">
                ...
                {/* PUBLICACIONES */}
                <section
                    className="flex flex-col gap-14 items-center my-14 m-auto px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32"
                    id="publicaciones"
                >
                    <div>
                        <h2 className="text-2xl md:text-3xl font-bold font-lora">
