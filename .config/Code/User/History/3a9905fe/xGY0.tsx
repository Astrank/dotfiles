                ...
                <div className='fixed inset-0 flex items-center justify-center p-4'>
                    <Dialog.Panel className="flex flex-col gap-6 p-4 text-sm bg-primary-900 text-white rounded">
                            ...
                            <div className='flex gap-2 self-end'>
                                <button className='' onClick={() => toggleDeleteCommentAlert(false)}>Cancelar</button>
                                <button className='' onClick={() => deleteComment(comment.id, comment.post)}>Confirmar</button>
                            </div>
                    </Dialog.Panel>
                </div>
            </Dialog>
