                ...
                <div className='fixed inset-0 flex items-center justify-center p-4'>
                    <Dialog.Panel className="flex flex-col gap-6 p-4 text-sm bg-neutral-800 text-white rounded">
                            ...
                            <div className='flex self-end'>
                                <button className='p-2 hover:bg-neutral-700' onClick={() => toggleDeleteCommentAlert(false)}>Cancelar</button>
                                <button className='p-2 hover:bg-neutral-700' onClick={() => deleteComment(comment.id, comment.post)}>Confirmar</button>
                            </div>
                    </Dialog.Panel>
                </div>
            </Dialog>
