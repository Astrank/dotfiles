...
import { useFirestore } from "../utils/Comments"
...
const Comment = ({ comment }: CommentProps) => {
    ...
    const { likeComment, deleteComment } = useFirestore();
                    ...
                    <div>
                        ...
                        {isAdminBoxOpen &&
                            <div className="absolute mt-2 flex flex-col justify-start py-1 text-sm rounded overflow-hidden bg-neutral-800 text-white right-6 md:right-12 lg:right-44">
                                <button className='px-3 py-2 hover:bg-neutral-700' onClick={() => deleteComment(comment.id, comment.post)}>Eliminar Comentario</button>
