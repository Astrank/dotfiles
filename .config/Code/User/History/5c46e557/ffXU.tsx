...
const Fretboard = () => {
    const [strings, setStrings] = useState<number[]>(Theory.strings);
        ...
        <>
            <div className="flex flex-col gap-8">
                <div className="flex gap-4 justify-center items-center">
                    <select
                        name="notes"
                        className="p-1 cursor-pointer rounded px-2"
