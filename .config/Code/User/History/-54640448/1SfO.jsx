        ...
        <header className="text-primary w-full">
            ...
            <div className="header py-6 px-3 sm:px-10 md:py-8 md:px-14 lg:px-18 xl:px-32">
                ...
                <nav className={`navbar ${isNavToggled ? 'open' : ''} font-medium text-sm`}>
                    <ul aria-label="Primary" role="list" className="py-3 px-3 text-accent sm:px-10 md:px-14 lg:px-0 lg:text-custom_gray">
                        <li className="py-3 w-full border-b border-gray-200 lg:border-0">
                            <Link href="/estudio">
                                <a className="">
                                    El estudio
                                </a>
