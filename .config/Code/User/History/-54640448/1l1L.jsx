...
export default function Header() {
    ...
    return (
        <header className="text-primary w-full">
            ...
            {/* Main Header */}
            <div className="header py-6 md:py-8">
                <Link href="/">
                    <a className="text-4xl md:text-5xl font-bold uppercase ml-4 sm:ml-10 md:ml-14 lg:ml-18 xl:ml-32">Home</a>
                </Link>
                <nav className={`navbar ${isNavToggled ? 'open' : ''} px-4 md:mr-14 lg:mr-18 xl:mr-32 bg-white text-sm`}>
                    <ul aria-label="Primary" role="list" className="text-accent lg:text-custom_gray">
                        <li>
                            <Link href="/estudio">
                                <a className="">
                                    El estudio
                ...
                <button className={`hamburguer-menu ${isNavToggled ? 'clicked' : ''}`} onClick={() => toggleNav(!isNavToggled)}>
                    <span aria-hidden="true" className="bg-primary after:bg-primary before:bg-primary"></span>
                </button>
            </div>
        </header>
    );
