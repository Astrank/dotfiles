    ...
    return (
        <header className="text-primary w-full">
            ...
            <div className="header py-6 md:py-8">
                ...
                <nav className={`navbar ${isNavToggled ? 'open' : ''} md:mr-14 lg:mr-18 xl:mr-32 bg-white text-sm`}>
                    <ul aria-label="Primary" role="list" className="px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32 text-accent lg:text-custom_gray">
                        <li>
                            <Link href="/estudio">
                                <a className="">
                                    El estudio
