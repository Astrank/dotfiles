        ...
        <header className="text-primary w-full">
            ...
            <div className="header py-6 px-3 sm:px-10 md:py-8 md:px-14 lg:px-18 xl:px-32">
                ...
                <nav className={`navbar ${isNavToggled ? 'open' : ''}`}>
                    <ul aria-label="Primary" role="list" className="py-3 px-3 sm:px-10 text-accent lg:text-custom_gray">
                        <li className="w-full text-start border-b border-gray-200 lg:border-0">
                            <Link href="/estudio">
                                <a className="">
                                    El estudio
                                </a>
                        ...
                        <li className="border-b border-gray-200 lg:border-0">
