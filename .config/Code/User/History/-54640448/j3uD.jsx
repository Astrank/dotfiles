...
export default function Header() {
    ...
    return (
        <header className="text-primary w-full">
            {/* Top Header */}
            <div className="hidden px-3 sm:px-10 md:px-14 lg:px-18 xl:px-32 flex flex-row justify-between items-center border-b border-gray-200">
            ...
            <div className="relative flex justify-between items-center py-6 md:py-8">
                ...
                <button className={`menu ${isNavOpen ? 'clicked' : ''}`} onClick={() => toggleNav(!isNavOpen)}>
                    <span aria-hidden="true"></span>
                </button>
                <nav className={`navbar ${isNavOpen ? 'open' : ''} bg-white text-sm`}>
                    <ul aria-label="Primary" role="list" className="navbar-list text-accent lg:text-custom_gray">
                        <li>
                            <Link href="/estudio">
                                <a className="">
                                    El estudio
