    ...
    return (
        <div className='flex flex-col gap-4 mt-8 group' key={comment.id}>
            ...
            {replies && replies.length > 0 && 
                <button className={`flex items-center gap-2 font-bold self-start ${showingReplies ? "rotate-180" : ""}`} onClick={() => toggleReplies(!showingReplies)}>
                    <svg className="h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
