...
export default function Profesional(nombre, profesion, descripcion, img) {
    return (
        <div className="flex flex-col gap-6 relative">
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="text-sm text-gray-600 tracking-wider font-medium">{profesion}</span>
            </div>
            <p className="text-gray-600 leading-7 text-sm">{descripcion}</p>
