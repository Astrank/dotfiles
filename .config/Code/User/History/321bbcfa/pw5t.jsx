...
export default function Home() {
    return (
        <div className="container">
            ...
            <div className="landing | padding-block-700 flow">
            ...
            <section className="features | padding-block-700 flow">
            ...
            <footer className="even-columns footer">
                ...
                <div className="footer_contact flow">
                    ...
                    <ul role="list" aria-label="Social Media" className="social_icons">
                        <li>
                            <img
