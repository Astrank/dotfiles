...
export default function Home() {
    return (
        <div className="container">
            ...
            <main>
                ...
                <section className="demo">
                    <div className="demo-selectors">
                        <button className="demo-selector">Simple</button>
                    ...
                    <div className="demo-preview">
                        <div className="demo-header">
                            <h3 className="demo-title">Casamiento</h3>
                        ...
                        <div className="demo-body">
                            <Image src="/assets/nathan-dumlao-As8zq82LBpw-unsplash.jpg" alt="img-preview" layout="fill" objectFit="cover" />
                        </div>
                    </div>
                </section>

                <section className="features | wide-flow">
                ...
                <section className="packages | even-columns">
            ...
            <footer className="footer | even-columns">
                <a href="#" className="logo">
                    <img
                        src="assets/svg/aether.svg"
                        alt="logo"
                ...
                <div className="footer-contact | flow">
                    <h3 className="footer-email">invitacion@studio.com</h3>
                    <ul
                        role="list"
