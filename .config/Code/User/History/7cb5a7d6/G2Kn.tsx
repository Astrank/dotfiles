            ...
            <div className="flex flex-col gap-6 text-primary-900 mx-4 my-8 md:mx-10 lg:mx-14 xl:mx-44 mb-auto">
                ...
                <div className="flex flex-col gap-3">
                    <Link href="#" className="self-start">
                        <h2 className="font-asap text-2xl peer hover:text-primary-700">Titulo titulo</h2>
                        <p className="font-roboto font-light text-md text-primary-700 leading-8 text-justify peer-hover:text-primary-700">
