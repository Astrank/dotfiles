...
import { CommentProvider, useComments } from '../utils/Comments'
        ...
        <div className="flex flex-col items-center justify-center min-h-full">
          ...
          <div className='mt-20 w-1/2'>
            ...
            <div className='flex flex-col gap-4 my-4'>
              <textarea className='border border-black rounded py-2 px-4' placeholder='comment' />
