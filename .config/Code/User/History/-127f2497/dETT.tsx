                ...
                <div className="flex gap-4">
                        <Dialog.Root>
                            ...
                            <Dialog.Content className="">
                                <Dialog.Close className="w-full fixed inset-0 flex items-center justify-center p-4 z-10">
                                </Dialog.Close>
                                <div className="w-full fixed inset-0 flex items-center justify-center p-4 z-10">
