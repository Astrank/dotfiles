...
const EscrituraGrupal: NextPage<EscrituraGrupalProps> = ({ escritura }) => {
  ...
  return (
    <div className="min-h-screen text-primary-900 ">
      ...
      <section className="flex flex-col gap-8 mx-4 md:mx-10 lg:mx-14 lg:my-20 lg:mx-44">
        {stories
          ...
          .map(story => (
            <div key={story.id} className="flex flex-col gap-2">
              <p className="font-roboto font-light text-md text-primary-700 leading-8 md:text-lg">{story.content}</p>
