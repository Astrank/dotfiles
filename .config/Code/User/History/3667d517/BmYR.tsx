  ...
  return (
    <div className="min-h-screen text-primary-900 ">
      ...
      <section className="flex flex-col mx-4 md:mx-10 lg:mx-14 lg:my-20 lg:mx-44">
        <textarea onChange={() => setFragment(e => e.target.value)} name="" id="" rows={5} className="p-2 text-primary-700 outline-none border border-primary-700" placeholder="Continuación de la historia" />
        <button 
