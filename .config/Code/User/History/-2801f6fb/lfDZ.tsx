        ...
        <>
            ...
            <div className="flex flex-col-reverse md:grid md:grid-cols-2 h-screen text-primary-900">
                ...
                <div className="relative flex flex-col justify-center items-center mx-10 my-8 gap-10 md:justify-between md:mx-0">
                    <nav className="tracking-wide flex w-full justify-center">
                        <button
                            onClick={() => toggleNav(!isNavToggled)}
                            className={`hamburger hamburger__squeeze ${isNavToggled ? "is_active" : ""} self-end md:mr-10 lg:hidden`}
                            type="button"
                        >
                        ...
                        <div className={`navbar ${isNavToggled ? "open" : ""} flex gap-2 lg:gap-6`}>
                            <ul
                                className="flex flex-col justify-center gap-2 text-start px-4 md:px-10 lg:flex-row lg:text-start lg:gap-6"
                                role="List"
