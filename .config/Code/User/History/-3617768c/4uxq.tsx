    ...
    return (
        <div className="relative text-neutral-800 bg-neutral-100 dark:bg-neutral-900 dark:text-indigo-100 min-h-screen">
            ...
            <main className="my-20 flex flex-col justify-center w-full gap-20 max-w-4xl mx-auto">
                ...
                <section id="proyectos" className="flex flex-col gap-y-20 gap-x-6 justify-center lg:justify-between md:mx-auto md:flex-row md:flex-wrap">
                    {projects &&
            ...
            >
                <div className="flex flex-col justify-center items-center gap-10 text-center py-10 max-w-4xl lg:grid lg:grid-cols-2 lg:justify-between lg:items-start lg:px-0 lg:mx-auto">
                    <div className="flex flex-col items-center gap-6 lg:items-start max-w-xs">
