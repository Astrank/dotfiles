    ...
    return (
        <div className="relative text-neutral-800 bg-neutral-100 dark:bg-neutral-900 dark:text-indigo-100 min-h-screen">
            ...
            <main className="my-20 flex flex-col justify-center w-full gap-20 max-w-4xl mx-auto">
                ...
                <section id="proyectos" className="grid grid-cols-1 gap-y-16 items-start place-items-center mx-0 md:grid-cols-2 lg:grid-cols-3 lg:mx-0">
                    {projects &&
                ...
                >
                    ...
                    <p className="max-w-lg leading-7">Ademas del stack de abajo he trabajado en proyectos con C#, PostgreSQL, Vue. Ingles avanzado.</p>
