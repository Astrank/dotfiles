    ...
    return (
        <div className="relative text-neutral-800 bg-neutral-100 dark:bg-neutral-900 dark:text-indigo-100 min-h-screen">
            ...
            <main className="my-20 flex flex-col justify-center w-full gap-20">
                ...
                <section id="proyectos" className="flex flex-col gap-y-20 gap-x-6 max-w-4xl mx-auto justify-center lg:justify-between md:mx-auto md:flex-row md:flex-wrap">
                    {projects &&
