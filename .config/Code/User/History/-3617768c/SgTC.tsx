        ...
        <div className="relative text-neutral-800 bg-neutral-100 dark:bg-neutral-900 dark:text-indigo-100 min-h-screen">
            ...
            <main className="my-20 flex flex-col justify-center w-full gap-20 max-w-4xl mx-auto">
                ...
                <section
                    ...
                    id="sobre-mi"
                >
                    <h2 className="text-2xl font-bold leading-7">Sobre mí</h2>
                    <p className="max-w-lg">Ademas del stack de abajo he trabajado en proyectos con C#, PostgreSQL, Vue. Ingles avanzado.</p>
                    <div className="grid grid-cols-4 gap-8 justify-center my-10 place-items-center text-neutral-900 dark:text-neutral-200 max-w-md">
                        <svg
                            id="css"
                            className="h-10"
                            fill="#008ed1"
