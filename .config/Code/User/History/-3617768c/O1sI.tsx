...
const Home = ({ projects }: HomeProps) => {
    ...
    return (
        <div className="relative text-neutral-800 bg-neutral-100 dark:bg-neutral-900 dark:text-indigo-100 min-h-screen">
            <Head>
                <title>Portfolio | Martín Rabasa</title>
            ...
            <header className="flex justify-between max-w-4xl mx-auto font-bold py-6">
                <nav className="hidden lg:block">
                    <ul className="flex gap-6">
                        <li className="text-blue-400 dark:text-violet-300"><a href="/">Martín Rabasa</a></li>
                        <li className="dark:hover:text-violet-300"><a href="#proyectos">Proyectos</a></li>
                        <li className="dark:hover:text-violet-300"><a href="#sobre-mi">Sobre mí</a></li>
                        <li className="dark:hover:text-violet-300"><a href="#contacto">Contacto</a></li>
                    </ul>
                </nav>
                
                {theme == "dark" ? (
                        <button className="hidden lg:block" onClick={() => setLightTheme()}>
                            <svg
                        ...
                        <button className="hidden lg:block" onClick={() => setDarkTheme()}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <button
                    className={`ml-auto hamburger hamburger__squeeze lg:hidden ${
                        isNavOpen ? "is_active" : ""
                    }`}
                    type="button"
            ...
            <main className="my-20 flex flex-col justify-center w-full gap-20 max-w-4xl mx-auto">
                ...
                {/*<section id="proyectos" className="flex flex-col gap-y-20 gap-x-6 items-center md:items-start lg:justify-between md:mx-auto md:flex-row md:flex-wrap">*/}

                <section id="proyectos" className="grid grid-cols-1 gap-y-16 items-start place-items-center mx-3 md:grid-cols-2 lg:grid-cols-3 lg:mx-0">
                    {projects &&
                ...
                <section
                    className="flex flex-col items-center text-center gap-6 max-w-md mx-auto"
                    id="sobre-mi"
                >
                    <h2 className="text-2xl font-bold leading-9">Sobre mí</h2>
                    <p>Ademas del stack de abajo he trabajado en proyectos con C#, PostgreSQL, Vue. Ingles avanzado.</p>
                    <div className="grid grid-cols-4 gap-8 justify-center my-10 place-items-center text-neutral-900 dark:text-neutral-200">
                        <svg
                            id="css"
                            className="h-10"
                            fill="#008ed1"
            ...
            {showGoTop &&
                <button className="fixed rounded-full p-2 bottom-4 right-4 bg-blue-400 shadow z-10 lg:right-10 lg:bottom-10 dark:text-neutral-800 dark:bg-indigo-100" onClick={() => {
            ...
            >
                <div className="flex flex-col justify-center items-center gap-10 py-10 max-w-4xl lg:grid lg:grid-cols-2 lg:justify-between lg:items-start lg:px-0 lg:mx-auto">
                    <div className="flex flex-col items-center gap-6 text-center lg:text-start lg:items-start max-w-xs">
                        <span className="text-lg font-bold">Contactame!</span>
                        <p className="leading-7">Gracias por llegar hasta aca. Gracias por llegar hasta aca.</p>
                        <div className="flex gap-6">
                            <a
                        ...
                        <span className="underline">martinrabasa@gmail.com</span>
                    </div>
                    <form action="" className="flex flex-col gap-4 text-sm">
                        <div className="flex flex-col gap-2">
                            ...
                            <input
                                className="text-neutral-800 bg-neutral-100 px-2 py-1.5 rounded focus:outline focus:outline-2 focus:outline-blue-400 dark:focus:outline-violet-300"
                                name="name"
                                id="name"
                                type="text"
                            />
