...
export default function Home({ posts }) {
  ...
  return (
    <div ref={refScrollUp} className="flex flex-col lg:flex-row text-gray-700 bg-white dark:bg-dark dark:text-gray-200 transition duration-700 divide-x-none lg:h-screen lg:overflow-hidden">
