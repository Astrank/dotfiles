...
export default function Home({ posts }) {
    ...
    return (
        <div className="flex flex-col lg:flex-row text-gray-700 bg-white dark:bg-dark dark:text-neutral-200 transition duration-700 divide-x-none lg:h-screen lg:overflow-hidden">
            <nav className="w-full lg:w-96 flex flex-row py-8 lg:border-r lg:border-gray-300 dark:lg:border-none lg:flex-col gap-4 px-3 sm:px-6 md:px-14 lg:overflow-y-auto lg:px-6 justify-between lg:justify-start">
                <Switcher />
