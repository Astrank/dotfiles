...
export function TheoryProvider({ children }: {children : React.ReactNode}) {
    ...
    useEffect(() => {
        ...
        setHighlightedNotes([true, false, false, false, false, false, false]);
    }, [note, scale])
    ...
    return <TheoryContext.Provider value={{ note, setNote, scale, setScale, scaleChords, highlightedNotes, toggleHighlight }}>{children}</TheoryContext.Provider>;
}
