...
type TheoryContextType = {
    ...
    setHighlightedNotes: (arg0: boolean[]) => any,
    toggleHighlight: (number) => void,
}
...
export function TheoryProvider({ children }: {children : React.ReactNode}) {
    ...
    return <TheoryContext.Provider value={{ note, setNote, scale, setScale, scaleChords, highlightedNotes, setHighlightedNotes, toggleHighlight }}>{children}</TheoryContext.Provider>;
}
