...
const Obra: NextPage<ObraProps> = ({ invitado }) => {
    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col gap-2 text-primary-900 my-10 mx-4 md:mx-10 lg:mx-14 lg:my-20 lg:mx-44">
        ...
        <div className="flex flex-col gap-10 my-6">
          <h1 className="font-asap text-3xl">{invitado.title}</h1>
...
export const getStaticProps: GetStaticProps = (context) => {
  const invitado = posts.find((invitado) => invitado.slug === context.params?.slug);
...
export const getStaticPaths: GetStaticPaths = () => {
  return {
    paths: posts.map((invitado) => ({ params: { slug: invitado.slug } })),
    fallback: false,
  };
};
