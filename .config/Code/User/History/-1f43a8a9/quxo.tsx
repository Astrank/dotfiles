...
const Obra: NextPage<ObraProps> = ({ post, comments }) => {
    const { getComments, getAllComments, unsubscribe } = useComments();
...
export const getStaticProps: GetStaticProps = (context) => {
    ...
    if(post) {
        ...
        comments = onSnapshot(q, (commentsQuery) => {
            commentsQuery.docs.map((c) => {
                let comment = c.data();
                comment.id = c.id;
