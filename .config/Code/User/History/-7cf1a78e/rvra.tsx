            ...
            {toast &&
                <Toast.Provider duration={5000}>
                    <Toast.Root 
                        ...
                        className={`flex items-center text-white py-6 px-8 rounded ${toast.status == "success" ? "bg-green-300" : "bg-primary-900"} ${toast.status == "error" ? "bg-red-300" : "bg-primary-900"}`}>
