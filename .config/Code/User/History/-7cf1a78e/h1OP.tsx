            ...
            {toast &&
                <Toast.Provider duration={5000}>
                    <Toast.Root 
                        ...
                        className="flex items-center bg-red-300 text-primary-900 py-6 px-8 rounded">
                            <Toast.Title className="mr-8">{toast.title}</Toast.Title>
                            <Toast.Close>
                                <svg className="w-6 h-6 rounded hover:bg-red-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
