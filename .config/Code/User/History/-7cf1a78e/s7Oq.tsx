            ...
            {toast &&
                <Toast.Provider duration={5000}>
                    <Toast.Root 
                        ...
                        className="flex bg-red-300 text-primary-900 py-4 px-6 rounded">
                            <Toast.Title className="mr-8">{toast.title}</Toast.Title>
                            <Toast.Close>
                                <svg className="w-6 h-6 p-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
