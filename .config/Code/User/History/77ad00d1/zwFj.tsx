...
export default function Instagram() {
    const [isMobile, setIsMobile] = useState(typeof window !== "undefined" && window.innerWidth);
    ...
    useEffect(() => {
        ...
        const handleResizeWindow = () => setIsMobile(typeof window !== "undefined" && window.innerWidth);
