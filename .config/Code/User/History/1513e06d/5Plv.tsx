...
export function EscrituraGrupalProvider({ children }: {children : React.ReactNode}) {
    ...
    return <EscrituraGrupalContext.Provider value={{ comments, unsubscribe, getComments, getAllComments, postComment, replyComment, likeComment, deleteComment, deleteNotification }}>{children}</EscrituraGrupalContext.Provider>;
}
