...
export function EscrituraGrupalProvider({ children }: {children : React.ReactNode}) {
    ...
    const [stories, setStories] = useState<CommentType[]>([]);
    ...
    return <EscrituraGrupalContext.Provider value={{ getStories, stories, unsubscribe }}>{children}</EscrituraGrupalContext.Provider>;
}
