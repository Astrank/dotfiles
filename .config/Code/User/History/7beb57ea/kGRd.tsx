...
export function CommentsProvider({ children }: {children : React.ReactNode}) {
        ...
        if(user) {
            try {
                ...
                if (user.uid !== uid) {
                    ...
                    notifyAdmin(`${user.displayName} ha comentado en ${post}`)
                }
            } catch (e) {
    ...
    const notifyAdmin = async (notification: string, commentId: string, comment: string, postSlug: string, postTitle: string) => {
    ...
    const notifyUser = async (notification: string, replyingTo: string, commentId: string, comment: string, postSlug: string, postTitle: string) => {
